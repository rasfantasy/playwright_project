...
test('Проверка соответствия текста элементов навигации header', async ({ page }) => {
  await page.goto('https://playwright.dev/');
...
test('Проверка соответствия ссылок элементов навигации header', async ({ page }) => {
  await page.goto('https://playwright.dev/');
...
test('Проверка заголовка и переход на страницу установки', async ({ page }) => {
  await page.goto('https://playwright.dev/');
...
test('Проверка перехода на страницу', async ({ page }) => {
  await page.goto('https://playwright.dev/');
